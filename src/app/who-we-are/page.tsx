...
export const metadata: Metadata = buildSiteMetadata(
  "Who We Are",
  "How the APK Junction desk researches Android apps, writes guides, and updates pages for readers in Pakistan.",
  "/who-we-are"
);
  ...
  return (
    ...
    >
      <p>
        ...
        the apps we write about: install, register, open the wallet screen, and
        note what actually happens. The site is the public notebook from that
        work.
      </p>
      <h2 className="text-xl font-semibold text-foreground">How a guide is made</h2>
      <p>
        We start from a real search a reader would type — an app name plus APK,
        or a payment question. Then we install the build we are documenting,
        capture the first-run path, and write the steps in the order a new user
        meets them. If a withdrawal button is missing, or a bonus is locked
        behind a deposit, that fact stays in the article.
      </p>
      ...
      <p>
        When a login screen, package size, or payout rule changes, we edit the
