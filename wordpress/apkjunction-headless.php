<?php
/**
 * APK Junction — Headless WordPress Setup
 *
...
define('APKJUNCTION_REVALIDATE_SECRET', 'your-random-secret-here'); // match .env.local
...
add_action('save_post', 'apkjunction_revalidate_nextjs', 10, 2);
